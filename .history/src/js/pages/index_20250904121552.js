			...
			fetch(form.action, {
				...
				.then((response) => {
					if (response.ok) {
						...
						this.showToast("Thank you! Your inquiry has been sent. I'll get back to you soon.", 'success')
					} else {
				...
				.catch((error) => {
					...
					submitBtn.disabled = false
					submitBtn.textContent = originalText
					this.showToast('Sorry, there was an error sending your message. Please try again or contact me directly.', 'error')
